...
function MobileMenuDrawer({ isOpen, setIsOpen, navLinks, isLinkActive, handleNavClick, currentUser, handleLogout }: any) {
...
function DesktopNavLinks({ navLinks, isLinkActive, handleNavClick }: any) {
  return (
...
function DesktopCheckoutButton({ totalItems }: { totalItems: number }) {
  return (
    <Link
