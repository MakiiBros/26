              ...
              <div className="bg-[#121217] p-6 rounded-3xl border border-white/5 shadow-2xl relative overflow-hidden">
                ...
                {paymentMethod === 'yape' && (
                  <div className="bg-[#1a1a24] p-5 rounded-2xl border border-purple-500/20 text-center animate-in slide-in-from-top-2 duration-300">
                    ...
                    <h3 className="font-bold text-white mb-1">Paga con Yape</h3>
                    <p className="text-xs text-gray-400 mb-4 px-4">
                      1. Completa la orden y dale a "Pagar por WhatsApp".<br/>
                      2. Te enviaremos el QR oficial del dueño.<br/>
                      3. Yapeas y nos pasas la captura por ahí mismo.
                    </p>
                    <div className="text-sm font-mono text-purple-400 bg-purple-500/10 py-2 px-4 rounded-lg inline-block border border-purple-500/20">
